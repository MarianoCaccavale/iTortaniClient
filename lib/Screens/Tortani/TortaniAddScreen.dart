        ...
        try{
          ...
          showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  title: Text('Errore'),
                  content: Text('C\'è stato un problema nell\'inserimento dell\'ordine, controlla la connessione internet e riprova.\n Errore: ${e.toString()}'),
                  actions: [
                    TextButton(
                      child: Text('Capito'),
                      onPressed: () => Navigator.of(context).pop(),
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text('Errore'),
                content: Text(
                    'C\'è stato un problema nella conferma dell\'ordine, controlla i dati e riprova'),
                actions: [
                  TextButton(
                    child: Text('Capito'),
                    onPressed: () => Navigator.of(context).pop(),
